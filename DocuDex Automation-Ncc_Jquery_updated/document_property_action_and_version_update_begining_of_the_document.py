...
driver.get("http://27.147.184.165:8005/documents/upload")
wait.until(EC.presence_of_element_located((By.TAG_NAME, "body")))
time.sleep(2)

# File full path (Windows path must be raw string or double backslashes)
file_path = r"C:\Users\Administrator\Desktop\Docudex-Automation\DocuDex Automation-Ncc_Jquery_updated\Demo file Upload for Testing\PDF Folder\file-sample_150kB.pdf"
...
file_path = r"C:\Users\Administrator\Desktop\Docudex-Automation\DocuDex Automation-Ncc_Jquery_updated\Demo file Upload for Testing\OCR Test\ocr.pdf"
...
file_path_2 = r"C:\Users\Administrator\Desktop\Docudex-Automation\DocuDex Automation-Ncc_Jquery_updated\Demo file Upload for Testing\PDF Folder\file-example_PDF_1MB.pdf"
...
start_radio = WebDriverWait(driver, 60).until(
    EC.element_to_be_clickable((
        By.XPATH,
        "//label[contains(normalize-space(),'Beginning of the document')]"
    ))
)

driver.execute_script("arguments[0].click();", start_radio)
print("✅ Selected 'Beginning of the document'")
time.sleep(1)
...
minor_radio = WebDriverWait(driver, 60).until(
    EC.element_to_be_clickable((
        By.XPATH,
        "//label[contains(normalize-space(),'Minor changes')]"
    ))
)
...
comment_box_new.send_keys("Document has been mergered at the beginning of the document as Minor changes Version")
