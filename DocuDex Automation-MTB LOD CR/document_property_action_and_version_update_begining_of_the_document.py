...
driver.get("http://27.147.184.165:8082/documents/upload")
...
select.select_by_visible_text("CAD (Credit Administration Department)")
...
select.select_by_visible_text("Kashfia Nehereen")

print("✅ User selected: Kashfia Nehereen")
